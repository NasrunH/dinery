...
export default function LoginPage() {
  ...
  // const [error, setError] = useState(""); // [2] Hapus state error manual (tidak butuh lagi)
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // [3] Loading Toast (Memberi feedback visual instan)
    ...
    try {
      ...
      // [4] Sukses! Dismiss loading dan tampilkan sukses
      toast.dismiss(loadingToast);
      toast.success(`Selamat datang, ${res.user.display_name}!`);
      ...
      // [5] Gagal! Dismiss loading dan tampilkan error
      toast.dismiss(loadingToast);
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-8 bg-white max-w-md mx-auto">
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        {/* [6] Hapus div error merah yang lama */}
